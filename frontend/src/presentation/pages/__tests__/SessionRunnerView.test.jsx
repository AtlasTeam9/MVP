...
vi.mock('../../../application/hooks/sessionHooks/useSessionState', () => ({
    useSessionState: () => mocks.sessionState,
}))

vi.mock('../../../application/hooks/sessionHooks/useSessionRedirect', () => ({
    useSessionRedirect: (...args) => mocks.useSessionRedirect(...args),
}))

vi.mock('../../../application/hooks/sessionHooks/useSessionHandlers', () => ({
