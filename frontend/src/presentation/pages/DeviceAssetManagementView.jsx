import styles from '@presentation/pages/DeviceAssetManagementView.module.css'
...
import { useAssetManagement } from '@application/hooks/useAssetManagement'
import binIcon from '@presentation/assets/icons/bin.png'
