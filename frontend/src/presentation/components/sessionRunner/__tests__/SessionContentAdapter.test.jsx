...
import { buildSessionContextValue } from '@presentation/components/sessionRunner/sessionContextValueBuilder'
...
vi.mock('@application/hooks/useSessionRunnerTrees', () => ({
    useSessionRunnerTrees: () => [{ id: 'REQ1', title: 'Tree title', nodes: { node1: { question: 'Q' } } }],
}))
...
describe('SessionContentAdapter integration', () => {
    it('injects tree data into SessionContent', () => {
        render(
            <MemoryRouter>
